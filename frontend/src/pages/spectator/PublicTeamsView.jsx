      ...
      <div className="relative p-5 space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-center text-center gap-2 w-1/3">
            <div className={`w-16 h-16 rounded-full bg-slate-900 border-2 flex items-center justify-center text-4xl transition-colors ${isLive ? 'border-rose-500/50' : winner === 'A' ? 'border-amber-400/60' : 'border-slate-700'
              }`}>
              {match.teamALogo || 'A'}
            </div>
          ...
          {/* Team B */}
          <div className="flex flex-col items-center text-center gap-2 w-1/3">
            <div className={`w-16 h-16 rounded-full bg-slate-900 border-2 flex items-center justify-center text-4xl transition-colors ${isLive ? 'border-rose-500/50' : winner === 'B' ? 'border-amber-400/60' : 'border-slate-700'
              }`}>
              {match.teamBLogo || 'B'}
            </div>
