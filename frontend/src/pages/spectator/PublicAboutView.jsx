        ...
        <div className="min-h-screen flex flex-col bg-darkBg text-slate-100">
            ...
            <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div className="text-center">
                    <Building className="w-12 h-12 mx-auto text-blue-400 bg-blue-500/10 p-3 rounded-2xl border border-blue-500/20" />
                    <h1 className="text-3xl font-black font-heading text-white mt-4">About Our Organization</h1>
                    <p className="text-sm text-slate-400 mt-1">Dedicated to fostering sports talent and competitive spirit.</p>
                </div>

                <div className="glass-card rounded-2xl p-6 border border-slate-800 space-y-6">
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                        <Info className="w-5 h-5 text-emerald-400" /> Our Mission
                    </h2>
                    ...
                    <h2 className="text-xl font-bold text-white flex items-center gap-2 pt-4 border-t border-slate-800">
                        <Trophy className="w-5 h-5 text-amber-400" /> Our Vision
                    </h2>
                    <p className="text-slate-300 leading-relaxed">
                    ...
                    <h2 className="text-xl font-bold text-white flex items-center gap-2 pt-4 border-t border-slate-800">
                        <Users className="w-5 h-5 text-purple-400" /> Our Team
                    </h2>
                    <p className="text-slate-300 leading-relaxed">
                    ...
                    <ul className="space-y-2 text-slate-300 text-sm">
                        <li className="flex items-center gap-2">
                            <Mail className="w-4 h-4 text-blue-400" /> Email: <a href="mailto:info@franchiseauction.com" className="text-blue-300 hover:underline">info@franchiseauction.com</a>
                        </li>
                        <li className="flex items-center gap-2">
                            <Phone className="w-4 h-4 text-emerald-400" /> Phone: +1 (555) 123-4567
                        </li>
                        <li className="flex items-center gap-2">
                            <MapPin className="w-4 h-4 text-rose-400" /> Address: 123 Sports Arena Rd, City, Country
                        </li>
                        <li className="flex items-center gap-2">
                            <ExternalLink className="w-4 h-4 text-purple-400" /> Website: <a href="https://www.example.com" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:underline">www.example.com</a>
                        </li>
                    </ul>
                </div>
